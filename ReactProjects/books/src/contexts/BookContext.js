...
export const BookContext = React.createContext(); //BookContext iletilmek istenilen veriler için kullanılacak //create ile BookContext oluşturulur

class BookContextProvider extends React.Component { //veriyi oluşturduğumuz class componentının içerisine aldık
...
//context api için 2 yöntem kullanılır
// 1-)Default value -->this.context 
// *Context nesnesini oluştur React.createContext ile
// *Başlangıç değerleri ver ve export et (export default)
// *Kullanmak istediğimiz component da import ettik (BookList de import ettik)
// *BookList te static contextType olarak atadık
// *this.context ile ilgili veriye ulaştık


//2-)Provider --> consumer
// *BookContext içerisinde class  component oluşturduk ve veriyi state içerisine yerleştirdik
// * <BookContext.Provider> ->  Contexte ait Provider ile state a ait veriyi aldık
// * {this.props.children} ile parent-child(BookContext-BookList) ilişkisini kurduk ilgili verinin child a ulaşmasını sağladık value={this.state} ile
// *BookList de BookContext i import edilmeli ve consumer kullanılmalı - veriyi göndereceğimiz component da context i import ederiz
// *render içerisinde consumer ile provider dan gelen veriyi yakalıyoruz(BookList- child da)
